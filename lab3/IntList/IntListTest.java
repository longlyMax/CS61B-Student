...
public class IntListTest {
    ...
    public void testReverse() {
        ...
        IntList myReverseList = IntList.reverse(myList);

        IntList testList = IntList.of(3, 2, 1, 0);
        assertEquals(testList, myReverseList);
        assertNotEquals(myList, myReverseList);
